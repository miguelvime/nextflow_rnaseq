...
\title{\includegraphics[width=0.6\textwidth]{imagenes/UEM.png}\\[1cm] \textbf{Memoria del Análisis Nextflow}\\ \Large Pipeline de RNA-seq en Nextflow (Dataset GSE52778)}
\author{\LARGE Máster en Bioinformática\\[0.5cm]
...
Para el desarrollo del pipeline y la redacción de esta memoria, se han utilizado varios modelos LLM integrados en el entorno de desarrollo VSCode, así como el uso de agentes de IA como OpenCode para una correcta y completa creación del pipeline en Nextflow.
